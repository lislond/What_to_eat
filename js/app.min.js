$(function () {
    ...
    var i = 0,
        ...
        m = [
            ...
            ["中午"],
            ["下午", "拉面 烩面 热干面 刀削面 油泼面 炸酱面 炒面 重庆小面 米线 过桥米线 酸辣粉 土豆粉 螺狮粉 新疆炒米粉 锡纸花甲粉 凉皮 肉夹馍 羊肉汤 炒饭 盖浇饭 卤肉饭 烤肉饭 黄焖鸡米饭 驴肉火烧 川菜 火锅 酸菜鱼 烤串 披萨 烤鸭 汉堡 炸鸡 煎饼果子 生煎 麻辣拌 麻辣烫 麻辣香锅 冒菜 饺子 馄饨 土豆片夹馍".split(" ")]
        ],
        h = "小雪 益禾堂 霸王茶姬 茶话弄 茶百道 一黑黑 书亦 幸运咖 库迪 瑞幸 可口可乐 百事可乐 冰峰 水溶C 脉动 三得利乌龙茶 无糖可乐 雪碧 屌丝饮料 酸奶 矿泉水 白开水".split(" "),
    ...
    m[1][1] = m[2][1], a.on("animationend webkitAnimationEnd", function (t) {
        ...
        if (g.toggleClass("playing", !i), i) i = 0, "drink" == w && x.text(u[t(u.length)]), c.text("！"), l.find("span").text("换一个"), clearTimeout(b), document.title = a.text() + "快去干饭吧！";
        else {
            i = 1, k++, 2 == k && e("我就知道你会换一个"), 5 == k && e("你到底吃不吃"), 10 == k && e("你是吃了炫迈吗？"), 20 == k && e("别挑了，就吃这个"), 30 == k && e("不吃拉倒");
            var n = "eat" == w ? m[d][1] : h;
